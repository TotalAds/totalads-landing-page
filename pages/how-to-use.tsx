...
export default function HowToUse() {
  ...
  const steps = [
    ...
    {
      number: "02",
      title: "Add Your Email Domains",
      description:
        "Connect your email domains and set up sender identities for premium deliverability",
      icon: <Globe className="w-6 h-6" />,
      action: "Add domain and verify DNS records",
      details: [
        "Add unlimited email domains",
    ...
    },
    {
      ...
      description:
        "Import your prospect list via CSV, XLSX, or connect your CRM",
      icon: <Target className="w-6 h-6" />,
      action: "Upload leads.csv or connect CRM",
      details: [
    ...
    {
      number: "04",
      title: "Create & Launch Your Campaign",
      description:
        "Build personalized email sequences with AI assistance and send at scale",
      icon: <Sparkles className="w-6 h-8" />,
      action: "Design campaign and send",
      details: [
  ...
  const useCases = [
    {
      title: "Cold Email Outreach at Scale",
      description:
        "Send personalized cold emails to thousands of prospects with premium deliverability",
    ...
    },
    {
      ...
      description:
        "Automate your entire sales outreach workflow with intelligent campaign sequences",
    ...
    },
    {
      ...
      description:
        "Reach out to candidates and passive talent with personalized email campaigns",
      icon: <Target className="w-8 h-8" />,
      benefits: [
